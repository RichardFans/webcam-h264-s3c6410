...
static void *rendering(void *arg)
{
	...
	//printf("!!! SrcWidth:%d  SrcHeight:%d DstWidth:%d  DstHeight:%d \n",pp_param->SrcWidth, pp_param->SrcHeight, pp_param->DstWidth, pp_param->DstHeight);	
...
int Forlinx_Test_Display_Optimization1(int argc, char **argv, int lcdnum)
{
...
*/
	...
	osd_info_to_driver.Height		= lcdsize[lcdnum][0];//480;	// display height
